...
class RecruiterPlansScreen extends StatefulWidget {
  RecruiterPlansScreen({Key? key}) : super(key: key);
  @override
  _RecruiterPlansScreenState createState() => new _RecruiterPlansScreenState();
}

class _RecruiterPlansScreenState extends State<RecruiterPlansScreen> {

late Color box1color, box2color;
              ...
              new Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text("Recruiter Plans",maxLines:2,style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold),
                      ),
                    ),
                  ]
              ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(getTranslated("IDEAL_FOR_POSTING", context)!+itemNo.totalJobPost!+" Jobs", style: LatinFonts.aBeeZee(fontSize: 12), maxLines: 2, overflow: TextOverflow.ellipsis),
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  ...
                  Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text('Package Type :', style: LatinFonts.aBeeZee(fontSize: 12,), maxLines: 2, overflow: TextOverflow.ellipsis),
                        Text(itemNo.type!, style: LatinFonts.aBeeZee(fontSize: 12,), maxLines: 2, overflow: TextOverflow.ellipsis),
                      ]
                  ),
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Row(
                      ...
                      children: [
                        ...
                        Text(itemNo.totalJobPost!+ " Jobs", style: LatinFonts.aBeeZee(fontSize: 12,), maxLines: 2, overflow: TextOverflow.ellipsis),
                      ]
                  ),
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text('Candidates per jobs : ', style: LatinFonts.aBeeZee(fontSize: 12,), maxLines: 2, overflow: TextOverflow.ellipsis),
                        Text(itemNo.profilePerApplication! + " Candidates", style: LatinFonts.aBeeZee(fontSize: 12,), maxLines: 2, overflow: TextOverflow.ellipsis),
                      ]
                  ),
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Row(
                      ...
                      children: [
                        ...
                        Text(itemNo.days! + " Days", style: LatinFonts.aBeeZee(fontSize: 12,), maxLines: 2, overflow: TextOverflow.ellipsis),
                      ]
                  ),
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Row(
