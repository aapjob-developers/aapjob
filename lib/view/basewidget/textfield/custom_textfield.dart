  ...
  Widget build(context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isOtp?Colors.amber:Colors.white,
      ...
      child: TextFormField(
        style: TextStyle(color: isOtp ? Colors.white : Colors.black),
        controller: controller,
        maxLines: maxLine ?? 1,
        textCapitalization: capitalization,
        maxLength: isPhoneNumber==true ? 15 : (isOtp?1:null),
        focusNode: focusNode,
