...
class JobLiveDataScreen extends StatefulWidget {
  JobLiveDataScreen({Key? key}) : super(key: key);
  @override
  _JobLiveDataScreenState createState() => new _JobLiveDataScreenState();
}

class _JobLiveDataScreenState extends State<JobLiveDataScreen> {
                ...
                child: new Column(
                    ...
                    children: <Widget>[
                      new Row(
                          ...
                          children: <Widget>[
                            new Container(
                              ...
                              Text('Hired by ${Itemlist[index].ComapnyName}',style: LatinFonts.aBeeZee(fontSize: 12, fontWeight: FontWeight.bold,color: Colors.white),),
                            ),
                          ]
                      ),
                      new Container(
                        ...
                        Text('Name : ${Itemlist[index].name}',style: LatinFonts.aBeeZee(fontSize: 12, fontWeight: FontWeight.bold,color: Colors.white),),
                      ),
                      new Container(
                        padding: EdgeInsets.all(3),
                        child:
                      ...
                      new Container(
                        ...
                        child:
                        //  Text('${duplicateJobsModel[index].companyName}',style: LatinFonts.aBeeZee(fontSize: 12, fontWeight: FontWeight.bold,color: Colors.white),),
                        Text('Job provided by AAP Job',style: LatinFonts.aBeeZee(fontSize: 14, fontWeight: FontWeight.bold,color: Colors.white),),
                      ),
                    ]
                ),
              ),
