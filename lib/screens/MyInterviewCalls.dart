...
class MyInterviewCalls extends StatefulWidget {
  MyInterviewCalls({Key? key,required this.Jobslist}) : super(key: key);
  List<JobsModel> Jobslist;
  @override
  _MyInterviewCallsState createState() => new _MyInterviewCallsState();
}

class _MyInterviewCallsState extends State<MyInterviewCalls> {
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: new Text("My Interview Calls",style: LatinFonts.aBeeZee(color:Colors.white,fontSize: 14,fontWeight: FontWeight.w700,fontStyle: FontStyle.italic ),softWrap: true,maxLines: 2,),
              ),
            ],
          ),
                            ...
                            Column(
                              children: [
                                Lottie.asset(
                                  ...
                                  width: MediaQuery.of(context).size.width*0.7,
                                  animate: true,),
                                Text("No Interview Calls Yet!! Apply More Jobs to increase Interview Calls",style: LatinFonts.aBeeZee(fontSize: 20),textAlign:TextAlign.center,),
