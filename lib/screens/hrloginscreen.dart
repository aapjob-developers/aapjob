...
import 'package:Aap_job/screens/hrotpscreen.dart';
...
class HrLoginScreen extends StatefulWidget {
  HrLoginScreen({Key? key}) : super(key: key);
  @override
  _HrLoginScreenState createState() => new _HrLoginScreenState();
}
...
class _HrLoginScreenState extends State<HrLoginScreen> {
  ...
  _submit() async {
    ...
    await Provider.of<AuthProvider>(context, listen: false).sendotp(mobile,otp,signature,"hr",route);
  }

  route(bool isRoute, String errorMessage) async {
    if (isRoute) {
      Navigator.pushReplacement(context,  MaterialPageRoute(builder: (context)=> HrOtpScreen()));
                            ...
                            new Row(
                                ...
                                children: <Widget>[
                                  Container(
                                      ...
                                      child: Text(getTranslated("RECRUITER_ENTER_YOUR_MOBILE", context)!,style: TextStyle(fontSize: 14,color: Colors.white),maxLines: 2,))
                                ]
