        ...
        new Row(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Text("Change Mobile Number ?",maxLines:2,style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold),
                ),
              ),
            ]
        ),
...
class _AuthCardState extends State<AuthCard> with CodeAutoFill{
  ...
  Future<void> _resend() async {
    ...
    await Provider.of<AuthProvider>(context, listen: false).sendotp(Provider.of<AuthProvider>(context, listen: false).getMobile(),Provider.of<AuthProvider>(context, listen: false).getOtp(),"yhtf654tre3","candidate",noroute);
  }
