...
class JobsModel {
  ...
  factory JobsModel.fromJson(Map<String, dynamic> json) => JobsModel(
    ...
    englishLevel: json["english_level"],
    jobskills: json["jobskills"]!=null?List<String>.from((json["jobskills"]).map((x) => x)):<String>[],
    des: json["des"],
    recruiterName: json["recruiter_name"],
    recruiterMobile: json["recruiter_mobile"],
    ...
    expiredAt: json["expired_at"]!=null?"2050-05-02":json["expired_at"],
    jobcity: json["jobcity"],
    jobcat: json["jobcat"],
    applied: json["applied"]!=null?json["applied"]:0,
